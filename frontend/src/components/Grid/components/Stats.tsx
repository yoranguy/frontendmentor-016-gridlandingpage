...
const Stats = (props: StatsProps) => {
    ...
    return ( 
        <> 
            <article id={String(props.index)} className={`flex flex-col gap-[30px] justify-between items-start px-[30px] py-[25px] h-[330px] min-[375px]: min-[1440px]:h-auto border-b-1 border-[var(--blue-400)] hover:bg-[#ffffff20] ${(props.index % 2) === 0 ? 'min-[375px]:border-r-1' : '' } `}>
